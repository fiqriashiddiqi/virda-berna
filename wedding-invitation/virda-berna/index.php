<?php
include('../virda-berna/koneksi.php');
?>
<!DOCTYPE html>
<html lang="en-US">
...
<head>
	<meta charset="UTF-8" />
	<meta name="description" content="Undangan pernikahan Virda dan Berna. Saturday, 06 August 2022.">
	<meta property="og:title" content="Undangan pernikahan Virda dan Berna. Saturday, 06 August 2022." />
	<meta property="og:url" content="https://virda-berna.digital-invitation.com/" />
	<meta property="og:description" content="Undangan pernikahan Virda dan Berna. Saturday, 06 August 2022.">
	<meta property="og:image" content="https://virda-berna.digital-invitation.com/1.bp.blogspot.com/-FuprKxe6I3I/X3waINlnqnI/AAAAAAAAFzo/DF1N99KVgt8ZjEiaNubMyRjz17nxGNAxQCLcBGAsYHQ/s16000/AZ--531.jpg">
...
<script type='text/javascript' src='../wp-content/plugins/wonderplugin-audio/engine/wonderpluginaudio41f0.js' id='wonderplugin-audio-script-js'></script>
  ...
  jQuery(document).ready(function($) {
    $('.nothanks').click(function() {
        $('#welcome-gate').addClass('move-gate');
			...
			</div> <!-- .et_pb_section --><div class="et_pb_section et_pb_section_2 et_pb_with_background et_section_regular section_has_divider et_pb_bottom_divider" style="background-color: #537a75!important;">
...
<p>( QS. Ar- Rum 21 )</p></div>
			...
			<div class="et_pb_section et_pb_section_3 et_pb_with_background et_section_regular" >
				...
				<div class="et_pb_text_inner">
					<h1>Dwi Berna P S, SE</h1>
                    <p><strong>The Son of</strong><br> Mr. Budianto<br> &amp; Mrs. Rani</p>
				</div>
			</div> <!-- .et_pb_text -->
			</div> <!-- .et_pb_column -->
				...
				<div class="et_pb_module et_pb_countdown_timer et_pb_countdown_timer_0 et_pb_no_bg et_pb_bg_layout_light" data-end-timestamp="1659747600">
			...
			</div> <!-- .et_pb_row --><div class="et_pb_with_border et_pb_row et_pb_row_5" style="border-color: #537a75!important;">
				 <!-- .et_pb_column -->
				...
				<div class="et_pb_blurb_content">
					...
					<div class="et_pb_blurb_container">
						...
						<div class="et_pb_blurb_description">
							<p style="font-size: 14px;color: #666666">Saturday, 06 August 2022<br> 08.00 WIB<br> <strong>bride's residence
	...
	<!-- <video id="myVideo" controls>
				  <source src="DIAS_AULIA.mp4" type="video/mp4">
				</video> -->
				<!-- <div class="video-container" style="margin-bottom: -171px">
  <iframe id="existing-iframe-example" src="DIAS_AULIA.mp4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div> -->
	...
	<div class="et_pb_section et_pb_section_3 et_pb_with_background et_section_regular" >
					...
					<div class="et_pb_with_border et_pb_row et_pb_row_5" style="border-color: #537a75!important;">
				...
				<div class="et_pb_blurb_content">
					...
					<div class="et_pb_blurb_container">
						...
						<div class="et_pb_blurb_description">
							...
							<a class="et_pb_button et_pb_button_1 et_animated et_pb_bg_layout_light" id="myBtn" style="background-color: #537a75!important;box-shadow: 0px 2px 18px 0px rgb(0 0 0 / 20%);">Send Gift</a>
						</div>
					</div>
				</div> <!-- .et_pb_blurb_content -->
			</div> <!-- .et_pb_blurb -->
			...
			<div class="et_pb_section et_pb_section_5 et_pb_with_background et_section_regular section_has_divider et_pb_bottom_divider et_pb_top_divider" style="background-color: #537a75!important;">
			...
			<div id="et_pb_contact_form_0" class="et_pb_module et_pb_contact_form_0 et_pb_contact_form_container clearfix" >
				...
				<div class="et_pb_contact">
					<form method="post" action="../virda-berna/tambah_pesan.php" id="form-input">
					...
					<p class="et_pb_contact_field et_pb_contact_field_2 et_pb_contact_field_last" data-type="text">
						...
						<div class="et_contact_bottom_container">
							...
							<button id="kirim" type="submit" class="et_pb_contact_submit et_pb_button" style="background-color: #537a75;box-shadow: 0px 2px 18px 0px rgb(0 0 0 / 20%);">Send</button>
						</div>
			 ...
			 <!-- .et_pb_row --><div class="et_pb_row et_pb_row_8">
				...
				<div class="et_pb_blurb_content">
					...
					<div class="et_pb_blurb_container">
						...
						<div class="et_pb_blurb_description"><p><br>Virda &amp; Berna</p></div>
					</div>
				</div> <!-- .et_pb_blurb_content -->
			</div> <!-- .et_pb_blurb -->
			</div> <!-- .et_pb_column -->
...
<audio id="myAudio" src="lagu/sound.mp3" preload="auto"></audio>
	...
	window.onclick = function(event) {
	  if (event.target == modal) {
		...
		// ---------------------------------- AUDIO ----------------------------------
	// var myAudio = document.getElementById("wonderpluginaudio-45");
...
<script src="../wp-content/themes/Divi/js/swiper.min.js"></script>
  	<script>
		...
		$(window).on("load", function() {
			...
			$('#wonderpluginaudio-45').on('click',function(){
				// $('#myModal').modal('hide');
				audioPlay();
			})
		});
